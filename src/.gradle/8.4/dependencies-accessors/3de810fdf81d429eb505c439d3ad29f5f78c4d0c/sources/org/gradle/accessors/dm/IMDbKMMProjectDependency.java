...
@NonNullApi
public class IMDbKMMProjectDependency extends DelegatingProjectDependency {

    @Inject
    public IMDbKMMProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
